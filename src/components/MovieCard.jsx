    ...
    className="group relative flex flex-col overflow-hidden rounded-2xl border border-[#F0BB3B]/50 transition hover:-translate-y-1 hover:shadow-yellow-500 hover:shadow-2xl/30 hover:cursor-pointer">
      <div className="relative aspect-2/3 overflow-hidden">
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1">
          {movie.hot && <span className="bg-red-500 text-white text-center text-xs font-bold px-2 py-1 rounded-full">HOT</span>}
          {movie.dangChieu && (
            <span className="bg-yellow-500 text-black text-center text-xs font-bold px-2 py-1 rounded-full">Đang chiếu</span>
          )}
          {movie.sapChieu && (
            <span className="bg-violet-500 text-white text-center text-xs font-bold px-2 py-1 rounded-full">Sắp chiếu</span>
          )}
        </div>
