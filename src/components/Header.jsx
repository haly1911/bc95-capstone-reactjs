...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 border-b border-white/10 bg-[#16091F]">
            ...
            >
              <nav>
                <ul className="flex flex-col gap-6 text-sm">
                  ...
                  <li>
                    <Link className="nav-titles block" to="/promotion" onClick={() => setIsMenuOpen(false)}>
                      Ưu Đãi
                    </Link>
                  </li>
                </ul>
